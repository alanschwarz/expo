...
import expo.modules.updates.manifest.LegacyManifest
...
class LegacyManifestTest {
    ...
    fun testGetAssetsUrlBase_ExpoDomain() {
        ...
        Assert.assertEquals(expected, LegacyManifest.getAssetsUrlBase(Uri.parse("https://exp.host/@test/test"), mockManifest))
        Assert.assertEquals(expected, LegacyManifest.getAssetsUrlBase(Uri.parse("https://expo.io/@test/test"),  mockManifest))
        Assert.assertEquals(expected, LegacyManifest.getAssetsUrlBase(Uri.parse("https://expo.test/@test/test"),  mockManifest))
    }
    ...
    fun testGetAssetsUrlBase_ExpoSubdomain() {
        ...
        val expected = Uri.parse("https://d1wp6m56sqw74a.cloudfront.net/~assets/")
        Assert.assertEquals(expected, LegacyManifest.getAssetsUrlBase(Uri.parse("https://staging.exp.host/@test/test"),  mockManifest))
        Assert.assertEquals(expected, LegacyManifest.getAssetsUrlBase(Uri.parse("https://staging.expo.io/@test/test"),  mockManifest))
        Assert.assertEquals(expected, LegacyManifest.getAssetsUrlBase(Uri.parse("https://staging.expo.test/@test/test"),  mockManifest))
    }
