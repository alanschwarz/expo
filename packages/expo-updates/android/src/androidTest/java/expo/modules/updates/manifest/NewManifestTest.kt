...
class NewManifestTest {
    ...
    fun testFromManifestJson_StripsOptionalRootLevelKeys() {
        ...
        val manifest1: Manifest = NewManifest.fromRawManifest(NewRawManifest(JSONObject(manifestJsonWithRootLevelKeys)), null, createConfig())
        ...
        val manifest2: Manifest = NewManifest.fromRawManifest(NewRawManifest(JSONObject(manifestJsonNoRootLevelKeys)), null, createConfig())
